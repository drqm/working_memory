...
avg = False
periods = {'all': [0,4],'encoding': [0, 2], 'transition': [1.5, 2.5],'delay': [2, 4]}#, 'retrieval': [4, 6]}
period = 'delay'
mode = 'patterns'
...
stats_fname = op.join(stats_dir,'{}_source_stats_{}.p'.format(mode,period))
