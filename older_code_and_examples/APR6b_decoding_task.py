...
lnames = ['recognize','invert'] # Log filenames block code
...
# Filename
suffix = '_task_{}_lf_{}_hf_{}_tstep_{}_twin_{}'.format(mode, l_freq, h_freq, tstep, twin)
...
dfun.plot_time_gen_accuracy(scores, times, nrows=2, ncols=2, vlines=[2],hlines=[2],
                            savefig=fig_path, vmin=0, vmax=1)