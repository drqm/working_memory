...
# Filename
suffix = '_{}_{}_lf_{}_hf_{}_tstep_{}_twin_{}_ncomps_{}'.format(block, mode, l_freq, h_freq, tstep, twin, ncomps)
...
if ncomps:
    comps_path = avg_path + '/data/{}/{}_comps{}.p'.format(sub,sub,suffix)
else:
    comps_path = None
...
################################# Perform decoding ##################################
gen, patterns, filters, scores, times, comps = dfun.WM_time_gen_classify(epochs, mode = mode,
                                                                  inv = inv, lmask = lmask,
                                                                  score = True, 
